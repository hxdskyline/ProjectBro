...
/// <summary>
/// 弃猫管理面板：提供列表容器、提示文本、确认与关闭按钮的 UI 根。
/// 上层负责向 `ListRoot` 填充卡片项并处理确认删除逻辑。
/// </summary>
public class DiscardPanel
{
    ...
    public void Initialize(RectTransform parent, Font uiFont)
    {
        ...
        Root = GetOrCreateChildRect(parent, "DiscardPanelRoot", new Vector2(0.52f, 0.08f), new Vector2(0.96f, 0.72f));
        ...
        HintText.text = "拖入弃猫区后会暂存；确认后这些猫将被永久删除。未确认前可拖回待选区。";
        ...
        ConfirmButton = GetOrCreateButton(Root, "ConfirmButton", "确认弃猫", _uiFont, new Vector2(0.52f, 0.86f), new Vector2(0.74f, 0.96f), new Color(0.55f, 0.18f, 0.18f, 1f));
