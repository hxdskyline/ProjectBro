...
/// <summary>
/// 游历面板 - 作为预制体加载的 MonoBehaviour 组件。
/// 由 CardBuildPanel 负责加载，往 ListRoot 填充卡片项并处理具体逻辑。
/// </summary>
public class OutingPanel : MonoBehaviour
{
    private const string PanelName = "游历区";
    private const string DefaultHint = "选择两只猫进行游历；游历返回的新卡会加入待选区。";
    ...
    private void EnsureRuntimeUI(RectTransform parent, Font font)
    {
        ...
        {
            GameObject panelGo = new GameObject("OutingPanel", typeof(RectTransform), typeof(Image));
        ...
        CreateButtonLabel(confirmRect, font, "确认游历");
