...
/// <summary>
/// 属性提升面板 - 作为预制体加载的 MonoBehaviour 组件。
/// 用于在战后为猫提供永久属性提升。
/// </summary>
public class AttributeBoostPanel : MonoBehaviour
{
    private const string PanelName = "属性提升区";
    private const string DefaultHint = "把想要强化的卡拖入此区域；确认后这些卡将获得永久提升并返回待选区。";
    ...
    private void EnsureRuntimeUI(RectTransform parent, Font font)
    {
        ...
        {
            GameObject panelGo = new GameObject("AttributeBoostPanel", typeof(RectTransform), typeof(Image));
        ...
        _hintText.color = new Color(0.72f, 0.9f, 0.94f, 1f);
        ...
        confirmImg.color = new Color(0.2f, 0.4f, 0.6f, 1f);
        _confirmButton.targetGraphic = confirmImg;
        CreateButtonLabel(confirmRect, font, "确认强化");
